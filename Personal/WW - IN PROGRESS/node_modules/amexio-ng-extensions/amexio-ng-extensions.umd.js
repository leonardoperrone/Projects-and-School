...
var FilterComponent = (function () {
     ...
     * @return {?}
     */
    FilterComponent.prototype.removeCheckStatus = function (col) {
...
var FilterTreeViewComponent = (function () {
     ...
     * @param {?} cdf
     */
    function FilterTreeViewComponent(_http, cdf) {
        this._http = _http;
        this.cdf = cdf;
        this.enableCheckBox = false;
        this.selectedRecord = new _angular_core.EventEmitter();
    ...
    FilterTreeViewComponent.prototype.callService = function () {
        ...
        var /** @type {?} */ requestJson = {};
        var /** @type {?} */ headers = new _angular_http.Headers({ 'Content-Type': 'application/json;charset=UTF-8' });
        var /** @type {?} */ options = new _angular_http.RequestOptions({ headers: headers, method: this.httpMethod });
        if (this.httpMethod == "post") {
            this._http.post(this.httpUrl, requestJson, options).subscribe(function (response) {
            ...
            this._http.get(this.httpUrl, options).subscribe(function (response) {
                _this.dataTableBindData = response.json();
            }, function (error) {
            }, function () {
                _this.renderServiceData();
...
var AutoCompleteService = (function () {
     ...
     * @return {?}
     */
    AutoCompleteService.prototype.fetchData = function (url, methodType) {
        var /** @type {?} */ requestJson = {};
        var /** @type {?} */ headers = new _angular_http.Headers({ 'Content-Type': 'application/json;charset=UTF-8' });
        var /** @type {?} */ options = new _angular_http.RequestOptions({ headers: headers, method: methodType });
        if (methodType == "post")
...
var CUSTOM_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR = {
    provide: _angular_forms.NG_VALUE_ACCESSOR,
    useExisting: _angular_core.forwardRef(function () { return AutoComplete; }),
    multi: true
};
...
var AutoComplete = (function (_super) {
    __extends$8(AutoComplete, _super);
    /**
     * @param {?} autoCompleteService
     */
    function AutoComplete(autoCompleteService) {
        var _this = _super.call(this) || this;
        _this.autoCompleteService = autoCompleteService;
    ...
    AutoComplete.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (this.httpMethod && this.httpUrl) {
            this.autoCompleteService.fetchData(this.httpUrl, this.httpMethod).subscribe(function (res) {
     ...
     * @return {?}
     */
    AutoComplete.prototype.showOptions = function () {
     ...
     * @return {?}
     */
    AutoComplete.prototype.setValue = function (value, ref) {
        this.value = value;
        this.showDropDown = false;
    };
    /**
     ...
     * @return {?}
     */
    AutoComplete.prototype.getResponseData = function (httpResponse) {
        var /** @type {?} */ responsedata = httpResponse;
        var /** @type {?} */ dr = this.dataReader.split(".");
        for (var /** @type {?} */ ir = 0; ir < dr.length; ir++) {
            responsedata = responsedata[dr[ir]];
     ...
     * @return {?}
     */
    AutoComplete.prototype.clearResult = function (inp) {
        this.showDropDown = false;
        this.filteredResult = [];
        inp.value = null;
        this.value = null;
...
var NavbarSubMenuComponent = (function () {
     ...
     * @return {?}
     */
    NavbarSubMenuComponent.prototype.ngAfterViewInit = function () {
    };
    /**
     * @param {?} nodeData
     * @return {?}
...
var SideNavBarComponent = (function () {
     ...
     * @param {?} _http
     */
    function SideNavBarComponent(_http) {
        this._http = _http;
        this.selectedNode = new _angular_core.EventEmitter();
